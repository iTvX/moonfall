...
public class TowerTop_Subs : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        texts.Add("I’d always thought I’d be a good alpinest");
        texts.Add("I mean, I could double jump in the air by stepping my left feet on my right toe.");
        texts.Add("Have you seen any other people that can do that? I have not.");
        i = 0;
        timer = 0;
